...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTRESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTRESULT actions', async () => {
      const expectedActions = [
        {
