...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './build.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUILD_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUILD actions', async () => {
      const expectedActions = [
        {
